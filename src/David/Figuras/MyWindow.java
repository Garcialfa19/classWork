...
public class MyWindow extends JFrame{
    ...
    private JPanelDrawing panelCentral = new JPanelDrawing();

    // Declaramos e incializamos el boton
    private JButton abrirBoton = new JButton("Open");
    private JButton salirBoton = new JButton("Exit");


    // Declaramos una referencia al objeto que pueda ser accesada desde las clases privadas
    private MyWindow este = this;
